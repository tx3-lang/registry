    ...
    <div className="flex items-center gap-14">
      <search className={twMerge('flex relative gap-8 w-full items-center text-zinc-400', className, dark && 'text-zinc-500')}>
        ...
        <input
          ...
          value={search}
          name="search-text"
          className={twMerge('text-lg w-full rounded-lg py-2.5 px-15 text-zinc-800 placeholder:text-zinc-400 placeholder:text-lg placeholder:font-normal', dark && 'border border-zinc-800 placeholder:text-zinc-500 text-zinc-200 bg-transparent ring-zinc-500')}
        />
        <TimesIcon
          className={
            clsx(
