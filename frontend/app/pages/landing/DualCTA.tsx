  ...
  return (
    <section className="container relative py-12">
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-6">
        <article className="relative overflow-hidden rounded-2xl border border-[#232326] bg-[#181818] px-8 py-7">
          <div className="relative flex flex-col gap-3.5">
            <div className="flex items-center gap-2.5 text-[11px] font-semibold tracking-[1.6px] uppercase text-primary-400">
              <span className="block h-[1.5px] w-3.5 bg-primary-400" />
              Use a protocol
            </div>
            <div className="flex flex-col gap-8">
              ...
              <Link
                to="/protocols"
                className="group inline-flex items-center gap-2 self-start bg-primary-600 hover:bg-primary-700 text-zinc-50 rounded-lg px-5 py-3 text-sm font-semibold transition-colors"
              >
                Browse the registry
          ...
          <div className="relative flex flex-col gap-3.5">
            ...
            <div className="flex flex-col gap-8">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group inline-flex items-center gap-2 self-start bg-blue-500 hover:bg-blue-600 text-zinc-50 rounded-lg px-5 py-3 text-sm font-semibold transition-colors"
              >
                Request integration
                <ArrowRightIcon width={16} height={16} className="transition-transform group-hover:translate-x-0.5" />
              </a>
